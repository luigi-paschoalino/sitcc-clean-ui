        ...
        <div className="mt-3 mt-md-5">
          ...
          >
            {universidades.map((universidade) => (
              <MenuItem value={universidade.id} key={universidade.id}>
                {universidade.nome}
              </MenuItem>
            ))}
          </Select>
          {institutos.length !== 0 ? (
            <div>
              ...
              {institutos.map((instituto) => (
                <Accordion>
                  <AccordionSummary>{instituto.nome}</AccordionSummary>
                  <AccordionDetails>
                    <div className="accordion-div">
                      <p>
                        <strong>Nome:</strong> {instituto.nome} <br />
                      </p>
                      <div>
                        <button
                          onClick={() =>
                            navigate(`/editar-instituto/${instituto.id}`)
                          }
                        >
                          <UpdateIcon />
                        </button>
