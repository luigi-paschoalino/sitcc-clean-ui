import React, { useState, useCallback, useEffect, DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_REACT_NODES } from "react";
...
export default function CriarCronograma() {
  ...
  const [requisitionInstituto, setRequisitionInstituto] = useState<boolean | null>(
    null
  );
